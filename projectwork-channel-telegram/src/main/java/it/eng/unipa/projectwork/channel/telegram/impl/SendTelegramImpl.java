...
public class SendTelegramImpl extends TelegramLongPollingBot implements SendTelegram {
	...
	@Override
	public void sendTelegram(MessageTelegram message, Long chatID) throws TelegramNotSendException {
		
		try{
			
			 SendMessage sendMessageTelegram = new SendMessage(); //c'era mailsession
			 sendMessageTelegram.setChatId(chatID)// destination = Chat_ID ex forzatura con chatID preimpostato
